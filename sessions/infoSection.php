 ...
 <div class="boxShow" align="center"><iframe class="boxShow" id="spot1" src = "" frameborder="0" scrolling="no"></iframe><div id="descriptorInfo1" class="descriptors"></div><br><div id="descriptorInfo2" class="descriptors"></div><br><div id="descriptorInfo3" class="descriptors"></div><br> &lt;<a>&#129172; back to menu</a></div>
  ...
  <div class="menuInfo">
 	<div class="scrollerTittle"><a>Scroll and click image to see info</a></div>
           ...
           <div class="container">
			<div class="rightMenu"  id="RotateA">App developed for this software laboratory for mayoralty office.
				<br><a class="imageClick">click in the left image please.</a>
			</div>
            <div class="leftMenu" id="RotateB"><input type="image" class="btnOk info" src="../images/thumbnails/vive.jpg" data-infoId="0" name="Info01" width="228" height="120" border="0" id="Info01" data-id="Info01"/></div>
            </div>
            
          <div class="container">
           <div class="rightMenu">App prototype developed for this software laboratory for mayoralty office.
			  <br><a class="imageClick">click in the left image please.</a>
			</div>
            <div class="leftMenu"><input type="image" class="btnOk info" src="../images/thumbnails/vive.jpg" data-infoId="1" name="Info02" width="228" height="120" border="0" id="Info02" /></div>
 			...
 			<div class="container">
         	<div class="rightMenu">App prototype developed for alpha male web club
			   <br><a class="imageClick">click in the left image please.</a>
			</div>
            <div class="leftMenu"><input type="image" class="btnOk info" src="../images/thumbnails/alpha.jpg" data-infoId="2" name="Info03" width="228" height="120" border="0" id="Info03" /></div>
            </div>
            
            
     		<div class="container">
          	<div class="rightMenu">Web site of big press productions.
				  <br><a class="imageClick">click in the left image please.</a>
			</div>
          ...
          <div class="container">
          <div class="rightMenu">Web site of electronic and electric devices distribution.
		    <br><a class="imageClick">click in the left image please.</a>
		  </div>
          ...
          <div class="container">
              <div class="rightMenu">Mark and website developed.
			    <br><a class="imageClick">click in the left image please.</a>
			  </div>
            ...
            <div class="container">
          	<div class="rightMenu">Video render made it for security enterprise.
			  <br><a class="imageClick">click in the left image please.</a>	
			</div>
            ...
            <div class="container">
         	<div class="rightMenu">Multimedia developed for this company in andina pack fest.
				  <br><a class="imageClick">click in the left image please.</a>
			</div>
            ...
            <div class="container">
            <div class="rightMenu">Multimedia and renders made it for this high tech enterprise.
			  <br><a class="imageClick">click in the left image please.</a>
			</div>
          ...
          <div class="container">
           <div class="rightMenu">Multimedia developed for this urban illumination company.
			  <br><a class="imageClick">click in the left image please.</a>
		   </div>
          <div class="leftMenu"><input type="image" class="btnOk info" src="../images/thumbnails/eecta.jpg" data-infoId="10" name="Info11" width="228" height="120" border="0" id="Info11" /></div>
           ...
           <div class="container">
          	<div class="rightMenu">Mark made it for software app.
		  		<br><a class="imageClick">click in the left image please.</a>  
			</div>
          <div class="leftMenu"><input type="image" class="btnOk info" src="../images/thumbnails/caktos.jpg" data-infoId="11" name="Info12" width="228" height="120" border="0" id="Info12" /></div>
            ...
            <div class="container">
            <div class="rightMenu">Mark made it for industrial enterprise.
				  <br><a class="imageClick">click in the left image please.</a>
			</div>
