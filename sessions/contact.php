...
<body>
	...
	<table>
		<tr>
			...
			<td><input type="image" src="../images/thumbnails/contactGirl.png" name="Image1" width="300" height="550" border="0" id="Image1" /><br></td>
			...
			<td>
			 ...
			 <form action="sessions/contacto/phpmailer/enviarCorreo.php" method="post" name="form1" id="form1" onsubmit="MM_validateForm('nombres','','R','empresa','','R','email','','RisEmail','ciudad','','R','telefono','','RisNum','mensaje','','R');return document.MM_returnValue">
				...
				<input type="submit" name="Submit" value="Send mail" mailto:doremi@dgflute.com="mailto:doremi@dgflute.com"> <input type="reset" name="Submit2" value="Restore" /></td>
